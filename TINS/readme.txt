...
4. copy the contents of /masks/ , appending each filename with "_M" into dataset
5. copy the contents of /depth/ , appending each filename with "_D" into dataset
6. copy the contents of /pose/ , appending each filename with "_P" into dataset
7. copy the contents of /canny/ , appending each filename with "_C" into dataset
